...
const paperDataList: PaperDataList = [
  ...
  },
  {
    ...
    author: "Jihun Kang, Daichi Haraguchi, Seiya Matsuda, Akisato Kimura, Seiichi Uchida",
    ...
    <>
      <Box mx="auto" height="auto" width={600} justifyContent="center">
        ...
        {paperDataList.map((item) => (
          <Box sx={{ width: 600, height: auto, my: 5}}>
